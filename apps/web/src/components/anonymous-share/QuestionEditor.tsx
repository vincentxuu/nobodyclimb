    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8 pb-24">
        ...
        <textarea
          ...
          className={`w-full resize-none rounded-lg border border-gray-200 bg-white p-4 leading-relaxed text-gray-900 placeholder:text-gray-400 focus:border-[#ffe70c] focus:outline-hidden focus:ring-2 focus:ring-[#ffe70c]/20 ${
