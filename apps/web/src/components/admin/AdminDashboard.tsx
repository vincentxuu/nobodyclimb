      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
          {contentStats.map((stat) => (
            <div
              key={stat.label}
              className="bg-white rounded-lg shadow-xs border border-wb-20 p-3 md:p-4 hover:shadow-md transition-shadow"
            >
      ...
      {notificationStats && (
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            <div className="bg-white rounded-lg shadow-xs border border-wb-20 p-4 md:p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          {quickLinks.map((link) => (
            <Link
              key={link.title}
              href={link.href}
              className="block bg-white rounded-lg shadow-xs border border-wb-20 p-4 md:p-5 hover:shadow-md hover:border-wb-30 transition-all group"
            >
