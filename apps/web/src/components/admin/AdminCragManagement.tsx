  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-4 h-[calc(100vh-180px)]">
        ...
        <div className="w-48 lg:w-72 shrink-0 bg-white rounded-lg shadow-xs border border-wb-20 flex flex-col overflow-hidden">
          <CragTree
        ...
        <div className="flex-1 bg-white rounded-lg shadow-xs border border-wb-20 flex flex-col overflow-hidden">
          {renderRightPanel()}
        </div>
      </div>
    </div>
