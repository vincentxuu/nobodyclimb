            ...
            <div className="h-48 flex items-end gap-1">
              {stats.hourlyTrend.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-full bg-linear-to-t from-brand-yellow-200 to-brand-yellow-100 rounded-t transition-all duration-300 hover:from-brand-yellow-200 hover:to-brand-yellow-200"
