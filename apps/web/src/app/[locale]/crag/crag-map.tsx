...
export function CragMap({ crags }: CragMapProps) {
  ...
  return (
    <div className="order-first col-span-full mb-6 lg:order-0 lg:col-span-1 lg:mb-0">
      <div className="rounded-xl bg-white p-4 pb-12 shadow-xs lg:sticky lg:top-24 lg:p-6 lg:pb-14">
