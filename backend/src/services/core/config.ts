...
import type { PipelineConfig } from '../orchestrators/pipeline/types'

export const DEFAULT_TOP_K = 5
export const MIN_VECTOR_SCORE = 0.5
export const DEFAULT_LLM_MODEL = '@cf/zai-org/glm-5.3-flash'
export const DEFAULT_LIGHTWEIGHT_MODEL = '@cf/zai-org/glm-4.7-flash'
